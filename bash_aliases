...
alias listen-to-them='activate ~/git_clones/resumai; python ~/git_clones/resumai/manage.py listen_stream --device-name "SteelSeries Arctis Nova 5"'
...
alias play-most-recent='ls -rt1 . | tail -n 20 | tr "\n" "\0" | xargs -0 mpv'
